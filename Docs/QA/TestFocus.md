# Closed-Alpha Test Focus

Primary focus for this build:

1. Can a tester start the local stack and launcher without developer help?
2. Can a tester log in, create/select a Human Warrior, and join Stonewake Vale?
3. Can a tester follow the assigned route and clearly mark PASS, FAIL, or BLOCKED?
