...
var stonewakeZoneMap = zoneMapDefinition{
	...
	Landmarks: []mapLandmarkDefinition{
		{ID: "hearthwatch_yard", DisplayName: "Hearthwatch Yard", Kind: "hub", X: 10, Y: 14},
		{ID: "training_ring", DisplayName: "Training Ring", Kind: "training", X: 58, Y: 32},
		{ID: "ditch_wall", DisplayName: "Ditch Wall", Kind: "objective", X: 118, Y: 60},
...
var stonewakeNavigationAreas = []navigationAreaDefinition{
	{ID: "hearthwatch_yard", DisplayName: "Hearthwatch Yard", Kind: "hub", CenterX: 10, CenterY: 14, Radius: 20, RouteHintText: "Return to the Hearthwatch Yard command post.", QuestIDs: []string{"sv_first_muster", "sv_wall_rats", "sv_break_poacher_line", "sv_bram_kettles_stand"}, TargetEntityID: npcCommanderElianRookID},
	{ID: "training_ring", DisplayName: "Training Ring", Kind: "objective", CenterX: 58, CenterY: 32, Radius: 20, RouteHintText: "Follow the packed yard path east to the training ring.", QuestIDs: []string{"sv_first_muster", "sv_yard_drills", "sv_stronger_lesson"}, TargetMobType: mobTrainingDummyTypeID, TargetEntityID: warriorTrainerID},
	{ID: "ditch_wall", DisplayName: "Ditch Wall", Kind: "objective", CenterX: 118, CenterY: 60, Radius: 32, RouteHintText: "Take the westward road out of Hearthwatch Yard until the ditch opens beside the wall.", QuestIDs: []string{"sv_wall_rats", "sv_scattered_kit"}, TargetMobType: mobDitchRatTypeID},
	{ID: "field_aid_post", DisplayName: "Field Aid Post", Kind: "service", CenterX: 32, CenterY: 37, Radius: 10, RouteHintText: "Return to Sella Wren near the yard's north path.", QuestIDs: []string{"sv_aid_for_the_hurt", "sv_crows_and_cloth"}, TargetEntityID: npcHealerSellaID},
...
var stonewakeMobSpawns = []mobSpawnDefinition{
	{ID: "mob_training_dummy_01", MobTypeID: mobTrainingDummyTypeID, DisplayName: "Yard Dummy", Level: 1, X: 55.0, Y: 27.0, MaxHealth: 30, AttackRange: 2.5, LeashRadius: 10, RespawnDelayMs: 3000},
	{ID: "mob_training_dummy_02", MobTypeID: mobTrainingDummyTypeID, DisplayName: "Yard Dummy", Level: 1, X: 63.0, Y: 32.0, MaxHealth: 30, AttackRange: 2.5, LeashRadius: 10, RespawnDelayMs: 3000},
	{ID: "mob_training_dummy_03", MobTypeID: mobTrainingDummyTypeID, DisplayName: "Yard Dummy", Level: 1, X: 56.0, Y: 38.0, MaxHealth: 30, AttackRange: 2.5, LeashRadius: 10, RespawnDelayMs: 3000},
	{ID: "mob_ditch_rat_01", MobTypeID: mobDitchRatTypeID, DisplayName: "Ditch Rat", Level: 1, X: 105.0, Y: 52.0, MaxHealth: 35, AggroRadius: 1.5, AttackRange: 2.5, AttackDamage: 2, AttackCadenceMs: 2000, MoveSpeedPerSec: 3.5, LeashRadius: 10, RespawnDelayMs: 8000},
	{ID: "mob_ditch_rat_02", MobTypeID: mobDitchRatTypeID, DisplayName: "Ditch Rat", Level: 1, X: 108.0, Y: 53.0, MaxHealth: 35, AggroRadius: 1.5, AttackRange: 2.5, AttackDamage: 2, AttackCadenceMs: 2000, MoveSpeedPerSec: 3.5, LeashRadius: 10, RespawnDelayMs: 8000},
	{ID: "mob_ditch_rat_03", MobTypeID: mobDitchRatTypeID, DisplayName: "Ditch Rat", Level: 1, X: 129.0, Y: 51.0, MaxHealth: 35, AggroRadius: 1.5, AttackRange: 2.5, AttackDamage: 2, AttackCadenceMs: 2000, MoveSpeedPerSec: 3.5, LeashRadius: 10, RespawnDelayMs: 8000},
	{ID: "mob_ditch_rat_04", MobTypeID: mobDitchRatTypeID, DisplayName: "Ditch Rat", Level: 1, X: 133.0, Y: 67.0, MaxHealth: 35, AggroRadius: 1.5, AttackRange: 2.5, AttackDamage: 2, AttackCadenceMs: 2000, MoveSpeedPerSec: 3.5, LeashRadius: 10, RespawnDelayMs: 8000},
	{ID: "mob_ditch_rat_05", MobTypeID: mobDitchRatTypeID, DisplayName: "Ditch Rat", Level: 1, X: 108.0, Y: 71.0, MaxHealth: 35, AggroRadius: 1.5, AttackRange: 2.5, AttackDamage: 2, AttackCadenceMs: 2000, MoveSpeedPerSec: 3.5, LeashRadius: 10, RespawnDelayMs: 8000},
	{ID: "mob_ditch_rat_06", MobTypeID: mobDitchRatTypeID, DisplayName: "Ditch Rat", Level: 1, X: 121.0, Y: 75.0, MaxHealth: 35, AggroRadius: 1.5, AttackRange: 2.5, AttackDamage: 2, AttackCadenceMs: 2000, MoveSpeedPerSec: 3.5, LeashRadius: 10, RespawnDelayMs: 8000},
