...
var stonewakeNavigationAreas = []navigationAreaDefinition{
	...
	{ID: "whispering_cave_road", DisplayName: "Whispering Cave Road", Kind: "handoff", CenterX: 375, CenterY: 77, Radius: 24, RouteHintText: "Report to Quartermaster Lyra near Whispering Cave.", QuestIDs: []string{"sv_westward_orders"}, TargetEntityID: npcQuartermasterLyraID},
}
