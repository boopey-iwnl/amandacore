...
var brindlebrookFriendlyNPCs = []friendlyNPCDefinition{
	...
	},
	{
		...
		Services: []npcService{
			...
			{Type: "quest", ServiceID: "bb_korrin_at_the_ford", Label: "Group: Korrin at the Ford"},
		},
	},
	{
...
var brindlebrookQuestDefinitions = []questDefinition{
	...
	{ID: "bb_korrin_at_the_ford", ZoneID: secondZoneID, Title: "Korrin at the Ford", ObjectiveType: objectiveKill, ObjectiveText: "[Group] Defeat Korrin Madbrook near Brindlebrook Ford. Recommended: 2 players.", GiverNPCID: npcBBRiverkeeperSolaID, TurnInNPCID: npcBBRiverkeeperSolaID, TargetMobType: mobBBKorrinMadbrookTypeID, TargetCount: 1, RewardXP: 650, RewardCopper: 150, PrerequisiteIDs: []string{"bb_teeth_in_shallows"}, LevelBand: "8 Group", MarkerX: 366.0, MarkerY: 184.0, PartyShareable: true, GroupRecommended: true, RecommendedPlayers: 2, PartyCreditRadius: 48.0},
...
var brindlebrookMobSpawns = []mobSpawnDefinition{
	...
	{ID: "mob_bb_korrin_madbrook_01", ZoneID: secondZoneID, MobTypeID: mobBBKorrinMadbrookTypeID, DisplayName: "Korrin Madbrook", Level: 8, X: 366.0, Y: 184.0, MaxHealth: 380, AggroRadius: 6, AttackRange: 2.75, AttackDamage: 19, AttackCadenceMs: 1900, MoveSpeedPerSec: 4, LeashRadius: 36, RespawnDelayMs: 45000, Classification: "elite", Elite: true},
