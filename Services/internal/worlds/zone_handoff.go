...
var zoneHandoffGateDefinitions = map[string]ZoneHandoffGateDefinition{
	"to_brindlebrook": {
...
func (s *worldServer) requestZoneHandoffLocked(session *worldSessionState, transitionID string) (ZoneHandoffDecision, error) {
	...
	gate := zoneHandoffGateDefinitions[request.TransitionID]
...
func (s *worldServer) buildZoneHandoffResponseLocked(session *worldSessionState) map[string]any {
	...
	for _, gate := range zoneHandoffGatesForZone(session.ZoneID) {
...
func zoneHandoffGatesForZone(zoneID string) []ZoneHandoffGateDefinition {
	gates := []ZoneHandoffGateDefinition{}
	for _, gate := range zoneHandoffGateDefinitions {
